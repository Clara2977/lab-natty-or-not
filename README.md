...
```markdown
# O Bistrô Invisível: Alta Gastronomia Zero Lactose ;)

## 📒 Descrição
Este projeto é um guia digital que apresenta receitas sofisticadas e totalmente livres de lactose. O objetivo principal foi criar um conteúdo visual tão fotorrealista que desafie a percepção do usuário sobre o que é real e o que é gerado por inteligência artificial, aplicando o conceito de "Natty or Not" (Natural ou Fake) à fotografia gastronômica.

## 🤖 Tecnologias Utilizadas
ChatGPT/Gemini: Para a criação e refinamento das receitas e descrições dos pratos.
Leonardo.ai / Midjourney: Para a geração das imagens ultra-realistas dos pratos.
Canva: Para a organização do layout e design final do guia.
Remove.bg (opcional): Para ajustes finos em elementos visuais.

## 🧐 Processo de Criação
Curadoria de Receitas: Utilizei a IA para selecionar pratos que tradicionalmente levam muito leite (como Risoto, Lasanha e Cheesecake), pedindo substituições realistas de ingredientes.
